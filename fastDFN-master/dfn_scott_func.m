...
function engy = dfn_scott_func(I,startpt)
global n_crate
...
% t1 = 100;%1C 3460
% t2 = 2000;%1C 3460
% I = [0 8*p.OneC*ones(1,t1) 2*p.OneC*ones(1,t2)];
...
% disp(' plot_dfn')
% disp(' animate_dfn')
%% Calculate remaining energy at 2C from the mid point
engy = sum(n_crate*Volt(startpt:k));
end
